...
export default function HomeProdType() {
  //Alert
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setRows(
          response.data?.p_type?.sort((a: any, b: any) =>
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios({
        method: apiP_Type.deleteP_Type.method,
        url: apiP_Type.deleteP_Type.url + codeToDelete,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  return (
    <>
      ...
      >
        ...
        <CustomButton variant="contained" href="/createptype">
          สร้างชนิดสินค้า
        </CustomButton>
      </Toolbar>
