...
export default function EditProduct() {
    ...
    const fetchData = async () => {
      try {
        const response = await axios({
          method: apiProducts.getOneProduct.method,
          url: apiProducts.getOneProduct.url + code,
          headers: {
        ...
        setFormData({
          ...
          type: response.data.product.type.code,
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios({
        method: apiProducts.editProduct.method,
        url: apiProducts.editProduct.url + code,
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
